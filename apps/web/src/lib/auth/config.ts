...
export const cognitoDomain = ensure(PUBLIC_COGNITO_DOMAIN, 'PUBLIC_COGNITO_DOMAIN');
export const clientId = ensure(PUBLIC_COGNITO_CLIENT_ID, 'PUBLIC_COGNITO_CLIENT_ID');
export const redirectUri = ensure(PUBLIC_COGNITO_REDIRECT_URI, 'PUBLIC_COGNITO_REDIRECT_URI');
